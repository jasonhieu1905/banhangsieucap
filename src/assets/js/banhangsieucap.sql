...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th10 26, 2017 lúc 03:14 PM
...
--
CREATE DATABASE IF NOT EXISTS `banhangsieucap` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `banhangsieucap`;
...
INSERT INTO `category` (`id`, `name`, `description`, `image`, `priority_id`) VALUES
(1, 'sneaker', 'description for sneakre', 'category_sneaker.jpg', 0),
(2, 'T-Shirt\r\n', 'Description T-shirt', 'category_tshirt.jpg', 0),
(3, 'Shirt', 'Description for Shirt', 'category_shirt.jpg', 0),
(4, 'Bottle', 'Description for bottle', 'category_bottle.jpg', 0),
(5, 'Headphone', 'Description for headphone', 'category_headphone.jpg', 0),
(6, 'jacket', 'Description for jacket', 'category_jacket.jpg', 0);
...
CREATE TABLE `contact` (
  `id` int(11) NOT NULL,
  `title1` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
...
(1, 'B store', 'When goods in started-price and B is the best choice for you!', 'When goods in started-price and B is the best choice for you!', '0938190592', '01203672707', 'hieu@gmail.com', 'test', 'http://facebook.com', 'http://google.com', 'http://googleplus.com'),
...
('root', '[{\"db\":\"banhangsieucap\",\"table\":\"category\"},{\"db\":\"banhangsieucap\",\"table\":\"product\"},{\"db\":\"banhangsieucap\",\"table\":\"contact\"},{\"db\":\"banhangsieucap\",\"table\":\"account\"}]');
...
('root', '2017-10-08 16:12:23', '{\"lang\":\"vi\",\"collation_connection\":\"utf8_unicode_ci\"}');
